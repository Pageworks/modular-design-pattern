...
# Generation Time: 2019-04-15 19:16:16 +0000
# ************************************************************
...
# Dump of table tb_assetindexdata
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_assetindexdata`;
...
CREATE TABLE `tb_assetindexdata` (
  ...
  PRIMARY KEY (`id`),
  KEY `tb_assetindexdata_sessionId_volumeId_idx` (`sessionId`,`volumeId`),
  KEY `tb_assetindexdata_volumeId_idx` (`volumeId`),
  CONSTRAINT `tb_assetindexdata_volumeId_fk` FOREIGN KEY (`volumeId`) REFERENCES `tb_volumes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_assets
# ------------------------------------------------------------
...
CREATE TABLE `tb_assets` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_assets_folderId_idx` (`folderId`),
  KEY `tb_assets_volumeId_idx` (`volumeId`),
  CONSTRAINT `tb_assets_folderId_fk` FOREIGN KEY (`folderId`) REFERENCES `tb_volumefolders` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_assets_id_fk` FOREIGN KEY (`id`) REFERENCES `tb_elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_assets_volumeId_fk` FOREIGN KEY (`volumeId`) REFERENCES `tb_volumes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_assettransformindex
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_assettransformindex`;
...
CREATE TABLE `tb_assettransformindex` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_assettransformindex_volumeId_assetId_location_idx` (`volumeId`,`assetId`,`location`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_assettransforms
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_assettransforms`;
...
CREATE TABLE `tb_assettransforms` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_assettransforms_name_unq_idx` (`name`),
  UNIQUE KEY `tb_assettransforms_handle_unq_idx` (`handle`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_categories` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_categories_groupId_idx` (`groupId`),
  KEY `tb_categories_parentId_fk` (`parentId`),
  CONSTRAINT `tb_categories_groupId_fk` FOREIGN KEY (`groupId`) REFERENCES `tb_categorygroups` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_categories_id_fk` FOREIGN KEY (`id`) REFERENCES `tb_elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_categories_parentId_fk` FOREIGN KEY (`parentId`) REFERENCES `tb_categories` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_categorygroups
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_categorygroups`;
...
CREATE TABLE `tb_categorygroups` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_categorygroups_name_idx` (`name`),
  KEY `tb_categorygroups_handle_idx` (`handle`),
  KEY `tb_categorygroups_structureId_idx` (`structureId`),
  KEY `tb_categorygroups_fieldLayoutId_idx` (`fieldLayoutId`),
  KEY `tb_categorygroups_dateDeleted_idx` (`dateDeleted`),
  CONSTRAINT `tb_categorygroups_fieldLayoutId_fk` FOREIGN KEY (`fieldLayoutId`) REFERENCES `tb_fieldlayouts` (`id`) ON DELETE SET NULL,
  CONSTRAINT `tb_categorygroups_structureId_fk` FOREIGN KEY (`structureId`) REFERENCES `tb_structures` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_categorygroups_sites
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_categorygroups_sites`;
...
CREATE TABLE `tb_categorygroups_sites` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_categorygroups_sites_groupId_siteId_unq_idx` (`groupId`,`siteId`),
  KEY `tb_categorygroups_sites_siteId_idx` (`siteId`),
  CONSTRAINT `tb_categorygroups_sites_groupId_fk` FOREIGN KEY (`groupId`) REFERENCES `tb_categorygroups` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_categorygroups_sites_siteId_fk` FOREIGN KEY (`siteId`) REFERENCES `tb_sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_content
# ------------------------------------------------------------
...
CREATE TABLE `tb_content` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_content_elementId_siteId_unq_idx` (`elementId`,`siteId`),
  KEY `tb_content_siteId_idx` (`siteId`),
  KEY `tb_content_title_idx` (`title`),
  CONSTRAINT `tb_content_elementId_fk` FOREIGN KEY (`elementId`) REFERENCES `tb_elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_content_siteId_fk` FOREIGN KEY (`siteId`) REFERENCES `tb_sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `tb_content` WRITE;
/*!40000 ALTER TABLE `tb_content` DISABLE KEYS */;

INSERT INTO `tb_content` (`id`, `elementId`, `siteId`, `title`, `dateCreated`, `dateUpdated`, `uid`)
VALUES
...
# Dump of table tb_craftidtokens
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_craftidtokens`;
...
CREATE TABLE `tb_craftidtokens` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_craftidtokens_userId_fk` (`userId`),
  CONSTRAINT `tb_craftidtokens_userId_fk` FOREIGN KEY (`userId`) REFERENCES `tb_users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_deprecationerrors
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_deprecationerrors`;
...
CREATE TABLE `tb_deprecationerrors` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_deprecationerrors_key_fingerprint_unq_idx` (`key`,`fingerprint`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_elementindexsettings
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_elementindexsettings`;
...
CREATE TABLE `tb_elementindexsettings` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_elementindexsettings_type_unq_idx` (`type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_elements
# ------------------------------------------------------------
...
CREATE TABLE `tb_elements` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_elements_dateDeleted_idx` (`dateDeleted`),
  KEY `tb_elements_fieldLayoutId_idx` (`fieldLayoutId`),
  KEY `tb_elements_type_idx` (`type`),
  KEY `tb_elements_enabled_idx` (`enabled`),
  KEY `tb_elements_archived_dateCreated_idx` (`archived`,`dateCreated`),
  CONSTRAINT `tb_elements_fieldLayoutId_fk` FOREIGN KEY (`fieldLayoutId`) REFERENCES `tb_fieldlayouts` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `tb_elements` WRITE;
/*!40000 ALTER TABLE `tb_elements` DISABLE KEYS */;

INSERT INTO `tb_elements` (`id`, `fieldLayoutId`, `type`, `enabled`, `archived`, `dateCreated`, `dateUpdated`, `dateDeleted`, `uid`)
VALUES
	(1,NULL,'craft\\elements\\User',1,0,'2019-03-26 23:48:50','2019-03-26 23:48:50',NULL,'fa15e35a-bf57-4cc0-8888-95ad9f24e665');

/*!40000 ALTER TABLE `tb_elements` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_elements_sites
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_elements_sites`;
...
CREATE TABLE `tb_elements_sites` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_elements_sites_elementId_siteId_unq_idx` (`elementId`,`siteId`),
  KEY `tb_elements_sites_siteId_idx` (`siteId`),
  KEY `tb_elements_sites_slug_siteId_idx` (`slug`,`siteId`),
  KEY `tb_elements_sites_enabled_idx` (`enabled`),
  KEY `tb_elements_sites_uri_siteId_idx` (`uri`,`siteId`),
  CONSTRAINT `tb_elements_sites_elementId_fk` FOREIGN KEY (`elementId`) REFERENCES `tb_elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_elements_sites_siteId_fk` FOREIGN KEY (`siteId`) REFERENCES `tb_sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `tb_elements_sites` WRITE;
/*!40000 ALTER TABLE `tb_elements_sites` DISABLE KEYS */;

INSERT INTO `tb_elements_sites` (`id`, `elementId`, `siteId`, `slug`, `uri`, `enabled`, `dateCreated`, `dateUpdated`, `uid`)
VALUES
	(1,1,1,NULL,NULL,1,'2019-03-26 23:48:50','2019-03-26 23:48:50','62803efc-580b-479f-bfb8-26ce0c6e32d6');

/*!40000 ALTER TABLE `tb_elements_sites` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_entries
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_entries`;
...
CREATE TABLE `tb_entries` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_entries_postDate_idx` (`postDate`),
  KEY `tb_entries_expiryDate_idx` (`expiryDate`),
  KEY `tb_entries_authorId_idx` (`authorId`),
  KEY `tb_entries_sectionId_idx` (`sectionId`),
  KEY `tb_entries_typeId_idx` (`typeId`),
  KEY `tb_entries_parentId_fk` (`parentId`),
  CONSTRAINT `tb_entries_authorId_fk` FOREIGN KEY (`authorId`) REFERENCES `tb_users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_entries_id_fk` FOREIGN KEY (`id`) REFERENCES `tb_elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_entries_parentId_fk` FOREIGN KEY (`parentId`) REFERENCES `tb_entries` (`id`) ON DELETE SET NULL,
  CONSTRAINT `tb_entries_sectionId_fk` FOREIGN KEY (`sectionId`) REFERENCES `tb_sections` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_entries_typeId_fk` FOREIGN KEY (`typeId`) REFERENCES `tb_entrytypes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_entrydrafts
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_entrydrafts`;
...
CREATE TABLE `tb_entrydrafts` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_entrydrafts_sectionId_idx` (`sectionId`),
  KEY `tb_entrydrafts_entryId_siteId_idx` (`entryId`,`siteId`),
  KEY `tb_entrydrafts_siteId_idx` (`siteId`),
  KEY `tb_entrydrafts_creatorId_idx` (`creatorId`),
  CONSTRAINT `tb_entrydrafts_creatorId_fk` FOREIGN KEY (`creatorId`) REFERENCES `tb_users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_entrydrafts_entryId_fk` FOREIGN KEY (`entryId`) REFERENCES `tb_entries` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_entrydrafts_sectionId_fk` FOREIGN KEY (`sectionId`) REFERENCES `tb_sections` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_entrydrafts_siteId_fk` FOREIGN KEY (`siteId`) REFERENCES `tb_sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_entrytypes
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_entrytypes`;
...
CREATE TABLE `tb_entrytypes` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_entrytypes_name_sectionId_idx` (`name`,`sectionId`),
  KEY `tb_entrytypes_handle_sectionId_idx` (`handle`,`sectionId`),
  KEY `tb_entrytypes_sectionId_idx` (`sectionId`),
  KEY `tb_entrytypes_fieldLayoutId_idx` (`fieldLayoutId`),
  KEY `tb_entrytypes_dateDeleted_idx` (`dateDeleted`),
  CONSTRAINT `tb_entrytypes_fieldLayoutId_fk` FOREIGN KEY (`fieldLayoutId`) REFERENCES `tb_fieldlayouts` (`id`) ON DELETE SET NULL,
  CONSTRAINT `tb_entrytypes_sectionId_fk` FOREIGN KEY (`sectionId`) REFERENCES `tb_sections` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_entryversions
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_entryversions`;
...
CREATE TABLE `tb_entryversions` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_entryversions_sectionId_idx` (`sectionId`),
  KEY `tb_entryversions_entryId_siteId_idx` (`entryId`,`siteId`),
  KEY `tb_entryversions_siteId_idx` (`siteId`),
  KEY `tb_entryversions_creatorId_idx` (`creatorId`),
  CONSTRAINT `tb_entryversions_creatorId_fk` FOREIGN KEY (`creatorId`) REFERENCES `tb_users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `tb_entryversions_entryId_fk` FOREIGN KEY (`entryId`) REFERENCES `tb_entries` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_entryversions_sectionId_fk` FOREIGN KEY (`sectionId`) REFERENCES `tb_sections` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_entryversions_siteId_fk` FOREIGN KEY (`siteId`) REFERENCES `tb_sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_fieldgroups
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_fieldgroups`;
...
CREATE TABLE `tb_fieldgroups` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_fieldgroups_name_unq_idx` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `tb_fieldgroups` WRITE;
/*!40000 ALTER TABLE `tb_fieldgroups` DISABLE KEYS */;

INSERT INTO `tb_fieldgroups` (`id`, `name`, `dateCreated`, `dateUpdated`, `uid`)
VALUES
	(1,'Common','2019-03-26 23:48:50','2019-03-26 23:48:50','95a08367-fb87-4b1a-b522-7d495b0ff6f9');

/*!40000 ALTER TABLE `tb_fieldgroups` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_fieldlayoutfields
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_fieldlayoutfields`;
...
CREATE TABLE `tb_fieldlayoutfields` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_fieldlayoutfields_layoutId_fieldId_unq_idx` (`layoutId`,`fieldId`),
  KEY `tb_fieldlayoutfields_sortOrder_idx` (`sortOrder`),
  KEY `tb_fieldlayoutfields_tabId_idx` (`tabId`),
  KEY `tb_fieldlayoutfields_fieldId_idx` (`fieldId`),
  CONSTRAINT `tb_fieldlayoutfields_fieldId_fk` FOREIGN KEY (`fieldId`) REFERENCES `tb_fields` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_fieldlayoutfields_layoutId_fk` FOREIGN KEY (`layoutId`) REFERENCES `tb_fieldlayouts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_fieldlayoutfields_tabId_fk` FOREIGN KEY (`tabId`) REFERENCES `tb_fieldlayouttabs` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_fieldlayouts
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_fieldlayouts`;
...
CREATE TABLE `tb_fieldlayouts` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_fieldlayouts_dateDeleted_idx` (`dateDeleted`),
  KEY `tb_fieldlayouts_type_idx` (`type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_fieldlayouttabs
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_fieldlayouttabs`;
...
CREATE TABLE `tb_fieldlayouttabs` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_fieldlayouttabs_sortOrder_idx` (`sortOrder`),
  KEY `tb_fieldlayouttabs_layoutId_idx` (`layoutId`),
  CONSTRAINT `tb_fieldlayouttabs_layoutId_fk` FOREIGN KEY (`layoutId`) REFERENCES `tb_fieldlayouts` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_fields
# ------------------------------------------------------------
...
CREATE TABLE `tb_fields` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_fields_handle_context_unq_idx` (`handle`,`context`),
  KEY `tb_fields_groupId_idx` (`groupId`),
  KEY `tb_fields_context_idx` (`context`),
  CONSTRAINT `tb_fields_groupId_fk` FOREIGN KEY (`groupId`) REFERENCES `tb_fieldgroups` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_globalsets
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_globalsets`;
...
CREATE TABLE `tb_globalsets` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_globalsets_name_unq_idx` (`name`),
  UNIQUE KEY `tb_globalsets_handle_unq_idx` (`handle`),
  KEY `tb_globalsets_fieldLayoutId_idx` (`fieldLayoutId`),
  CONSTRAINT `tb_globalsets_fieldLayoutId_fk` FOREIGN KEY (`fieldLayoutId`) REFERENCES `tb_fieldlayouts` (`id`) ON DELETE SET NULL,
  CONSTRAINT `tb_globalsets_id_fk` FOREIGN KEY (`id`) REFERENCES `tb_elements` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_info` (`id`, `version`, `schemaVersion`, `maintenance`, `config`, `configMap`, `fieldVersion`, `dateCreated`, `dateUpdated`, `uid`)
VALUES
	(1,'3.1.22','3.1.26',0,'a:7:{s:12:\"dateModified\";i:1555355672;s:5:\"email\";a:5:{s:9:\"fromEmail\";s:21:\"$SYSTEM_EMAIL_ADDRESS\";s:8:\"fromName\";s:18:\"$SYSTEM_EMAIL_NAME\";s:8:\"template\";N;s:13:\"transportType\";s:37:\"craft\\mail\\transportadapters\\Sendmail\";s:17:\"transportSettings\";N;}s:11:\"fieldGroups\";a:1:{s:36:\"95a08367-fb87-4b1a-b522-7d495b0ff6f9\";a:1:{s:4:\"name\";s:6:\"Common\";}}s:10:\"siteGroups\";a:1:{s:36:\"320dbaef-a3c8-41d0-9ef6-f50b94891b6e\";a:1:{s:4:\"name\";s:7:\"Default\";}}s:5:\"sites\";a:1:{s:36:\"19bcec29-0fe8-40ec-ab48-7caaaff62a9a\";a:8:{s:9:\"siteGroup\";s:36:\"320dbaef-a3c8-41d0-9ef6-f50b94891b6e\";s:4:\"name\";s:10:\"REPLACE ME\";s:6:\"handle\";s:7:\"default\";s:8:\"language\";s:5:\"en-US\";s:7:\"hasUrls\";b:1;s:7:\"baseUrl\";s:24:\"http://$DEFAULT_SITE_URL\";s:9:\"sortOrder\";i:1;s:7:\"primary\";b:1;}}s:6:\"system\";a:5:{s:7:\"edition\";s:4:\"solo\";s:4:\"name\";s:12:\"$SYSTEM_NAME\";s:4:\"live\";b:1;s:13:\"schemaVersion\";s:6:\"3.1.26\";s:8:\"timeZone\";s:16:\"America/New_York\";}s:5:\"users\";a:5:{s:24:\"requireEmailVerification\";b:1;s:23:\"allowPublicRegistration\";b:0;s:12:\"defaultGroup\";N;s:14:\"photoVolumeUid\";N;s:12:\"photoSubpath\";s:0:\"\";}}','{\"dateModified\":\"@config/project.yaml\",\"email\":\"@config/project.yaml\",\"fieldGroups\":\"@config/project.yaml\",\"siteGroups\":\"@config/project.yaml\",\"sites\":\"@config/project.yaml\",\"system\":\"@config/project.yaml\",\"users\":\"@config/project.yaml\"}','HajuNN3Xg4qX','2019-03-26 23:48:50','2019-04-15 19:14:32','15862080-d0fe-43ab-9ae3-bf4e6deec281');

/*!40000 ALTER TABLE `tb_info` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_matrixblocks
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_matrixblocks`;
...
CREATE TABLE `tb_matrixblocks` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_matrixblocks_ownerId_idx` (`ownerId`),
  KEY `tb_matrixblocks_fieldId_idx` (`fieldId`),
  KEY `tb_matrixblocks_typeId_idx` (`typeId`),
  KEY `tb_matrixblocks_sortOrder_idx` (`sortOrder`),
  KEY `tb_matrixblocks_ownerSiteId_idx` (`ownerSiteId`),
  CONSTRAINT `tb_matrixblocks_fieldId_fk` FOREIGN KEY (`fieldId`) REFERENCES `tb_fields` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_matrixblocks_id_fk` FOREIGN KEY (`id`) REFERENCES `tb_elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_matrixblocks_ownerId_fk` FOREIGN KEY (`ownerId`) REFERENCES `tb_elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_matrixblocks_ownerSiteId_fk` FOREIGN KEY (`ownerSiteId`) REFERENCES `tb_sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tb_matrixblocks_typeId_fk` FOREIGN KEY (`typeId`) REFERENCES `tb_matrixblocktypes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_matrixblocktypes
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_matrixblocktypes`;
...
CREATE TABLE `tb_matrixblocktypes` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_matrixblocktypes_name_fieldId_unq_idx` (`name`,`fieldId`),
  UNIQUE KEY `tb_matrixblocktypes_handle_fieldId_unq_idx` (`handle`,`fieldId`),
  KEY `tb_matrixblocktypes_fieldId_idx` (`fieldId`),
  KEY `tb_matrixblocktypes_fieldLayoutId_idx` (`fieldLayoutId`),
  CONSTRAINT `tb_matrixblocktypes_fieldId_fk` FOREIGN KEY (`fieldId`) REFERENCES `tb_fields` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_matrixblocktypes_fieldLayoutId_fk` FOREIGN KEY (`fieldLayoutId`) REFERENCES `tb_fieldlayouts` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_migrations
# ------------------------------------------------------------
...
CREATE TABLE `tb_migrations` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_migrations_pluginId_idx` (`pluginId`),
  KEY `tb_migrations_type_pluginId_idx` (`type`,`pluginId`),
  CONSTRAINT `tb_migrations_pluginId_fk` FOREIGN KEY (`pluginId`) REFERENCES `tb_plugins` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `tb_migrations` WRITE;
/*!40000 ALTER TABLE `tb_migrations` DISABLE KEYS */;

INSERT INTO `tb_migrations` (`id`, `pluginId`, `type`, `name`, `applyTime`, `dateCreated`, `dateUpdated`, `uid`)
VALUES
	...
	(136,NULL,'app','m190401_223843_drop_old_indexes','2019-04-15 19:14:32','2019-04-15 19:14:32','2019-04-15 19:14:32','d98cfad5-ae4d-4723-ab7e-7ea81cfb3309');

/*!40000 ALTER TABLE `tb_migrations` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_plugins
# ------------------------------------------------------------
...
CREATE TABLE `tb_plugins` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_plugins_handle_unq_idx` (`handle`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_queue
# ------------------------------------------------------------
...
CREATE TABLE `tb_queue` (
  ...
  `error` text,
  PRIMARY KEY (`id`),
  KEY `tb_queue_fail_timeUpdated_timePushed_idx` (`fail`,`timeUpdated`,`timePushed`),
  KEY `tb_queue_fail_timeUpdated_delay_idx` (`fail`,`timeUpdated`,`delay`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_relations
# ------------------------------------------------------------
...
CREATE TABLE `tb_relations` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_relations_fieldId_sourceId_sourceSiteId_targetId_unq_idx` (`fieldId`,`sourceId`,`sourceSiteId`,`targetId`),
  KEY `tb_relations_sourceId_idx` (`sourceId`),
  KEY `tb_relations_targetId_idx` (`targetId`),
  KEY `tb_relations_sourceSiteId_idx` (`sourceSiteId`),
  CONSTRAINT `tb_relations_fieldId_fk` FOREIGN KEY (`fieldId`) REFERENCES `tb_fields` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_relations_sourceId_fk` FOREIGN KEY (`sourceId`) REFERENCES `tb_elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_relations_sourceSiteId_fk` FOREIGN KEY (`sourceSiteId`) REFERENCES `tb_sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tb_relations_targetId_fk` FOREIGN KEY (`targetId`) REFERENCES `tb_elements` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_resourcepaths
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_resourcepaths`;
...
LOCK TABLES `tb_resourcepaths` WRITE;
/*!40000 ALTER TABLE `tb_resourcepaths` DISABLE KEYS */;

INSERT INTO `tb_resourcepaths` (`hash`, `path`)
VALUES
	('10131915','C:\\Users\\andre\\Desktop\\projects\\the-box\\vendor\\craftcms\\cms\\lib\\element-resize-detector'),
	('103d4a5c','@lib/fileupload'),
	...
	('72bde38e','@lib/picturefill'),
	('7519df4c','@lib/jquery-touch-events'),
	('767aac45','C:\\Users\\andre\\Desktop\\projects\\the-box\\vendor\\craftcms\\cms\\lib\\fabric'),
	('767ba5','@craft/web/assets/utilities/dist'),
	('77839ecf','@craft/web/assets/updater/dist'),
	...
	('7e40d890','@craft/web/assets/recententries/dist'),
	...
	('abefdcd0','@lib/element-resize-detector'),
	...
	('b7f9dccc','@app/web/assets/craftsupport/dist'),
	('b96b700d','@app/web/assets/updateswidget/dist'),
	...
	('d18774fc','@lib/element-resize-detector'),
	('d84351b3','@craft/web/assets/feed/dist'),
	('db591bfd','@lib/jquery-ui'),
	('e3875e50','@app/web/assets/feed/dist'),
	('e68cc09','C:\\Users\\andre\\Desktop\\projects\\the-box\\vendor\\craftcms\\cms\\lib\\jquery.payment'),
	('e7566cf7','@craft/web/assets/craftsupport/dist'),
	('ef50db3a','@craft/web/assets/login/dist'),
	('ef982874','@lib/velocity'),
	...
	('f3bf879c','@lib/jquery.payment'),
	('f70469bb','C:\\Users\\andre\\Desktop\\projects\\the-box\\vendor\\craftcms\\cms\\lib\\selectize'),
	('f717760','@lib/jquery-touch-events'),
	('f8e34cf4','C:\\Users\\andre\\Desktop\\projects\\the-box\\vendor\\craftcms\\cms\\lib\\selectize'),
	('f8e7577f','@app/web/assets/utilities/dist'),
	('fe17df09','@bower/jquery/dist');

/*!40000 ALTER TABLE `tb_resourcepaths` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_searchindex
# ------------------------------------------------------------
...
CREATE TABLE `tb_searchindex` (
  ...
  FULLTEXT KEY `tb_searchindex_keywords_idx` (`keywords`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

LOCK TABLES `tb_searchindex` WRITE;
/*!40000 ALTER TABLE `tb_searchindex` DISABLE KEYS */;

INSERT INTO `tb_searchindex` (`elementId`, `attribute`, `fieldId`, `siteId`, `keywords`)
VALUES
...
/*!40000 ALTER TABLE `tb_searchindex` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_sections
# ------------------------------------------------------------
...
CREATE TABLE `tb_sections` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_sections_handle_idx` (`handle`),
  KEY `tb_sections_name_idx` (`name`),
  KEY `tb_sections_structureId_idx` (`structureId`),
  KEY `tb_sections_dateDeleted_idx` (`dateDeleted`),
  CONSTRAINT `tb_sections_structureId_fk` FOREIGN KEY (`structureId`) REFERENCES `tb_structures` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_sections_sites
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_sections_sites`;
...
CREATE TABLE `tb_sections_sites` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_sections_sites_sectionId_siteId_unq_idx` (`sectionId`,`siteId`),
  KEY `tb_sections_sites_siteId_idx` (`siteId`),
  CONSTRAINT `tb_sections_sites_sectionId_fk` FOREIGN KEY (`sectionId`) REFERENCES `tb_sections` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_sections_sites_siteId_fk` FOREIGN KEY (`siteId`) REFERENCES `tb_sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_sequences
# ------------------------------------------------------------
...
CREATE TABLE `tb_sessions` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_sessions_uid_idx` (`uid`),
  KEY `tb_sessions_token_idx` (`token`),
  KEY `tb_sessions_dateUpdated_idx` (`dateUpdated`),
  KEY `tb_sessions_userId_idx` (`userId`),
  CONSTRAINT `tb_sessions_userId_fk` FOREIGN KEY (`userId`) REFERENCES `tb_users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `tb_sessions` WRITE;
/*!40000 ALTER TABLE `tb_sessions` DISABLE KEYS */;

INSERT INTO `tb_sessions` (`id`, `userId`, `token`, `dateCreated`, `dateUpdated`, `uid`)
VALUES
	...
	(2,1,'hW0SxlUq4ZaZFooB88vAHWDKP0uSJlegZjZoC0GnSsinRQRNiIREqKmvcEuPyY7mqztpGBKNidBBhsR98g5axer3_ZqrJV0rOHk8','2019-04-15 19:11:09','2019-04-15 19:14:48','6aad57ae-c9db-49ab-8cf3-641bab8aef67');

/*!40000 ALTER TABLE `tb_sessions` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_shunnedmessages
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_shunnedmessages`;
...
CREATE TABLE `tb_shunnedmessages` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_shunnedmessages_userId_message_unq_idx` (`userId`,`message`),
  CONSTRAINT `tb_shunnedmessages_userId_fk` FOREIGN KEY (`userId`) REFERENCES `tb_users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_sitegroups
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_sitegroups`;
...
CREATE TABLE `tb_sitegroups` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_sitegroups_name_idx` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `tb_sitegroups` WRITE;
/*!40000 ALTER TABLE `tb_sitegroups` DISABLE KEYS */;

INSERT INTO `tb_sitegroups` (`id`, `name`, `dateCreated`, `dateUpdated`, `dateDeleted`, `uid`)
VALUES
	(1,'Default','2019-03-26 23:48:50','2019-03-26 23:59:04',NULL,'320dbaef-a3c8-41d0-9ef6-f50b94891b6e');

/*!40000 ALTER TABLE `tb_sitegroups` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_sites
# ------------------------------------------------------------
...
CREATE TABLE `tb_sites` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_sites_dateDeleted_idx` (`dateDeleted`),
  KEY `tb_sites_handle_idx` (`handle`),
  KEY `tb_sites_sortOrder_idx` (`sortOrder`),
  KEY `tb_sites_groupId_fk` (`groupId`),
  CONSTRAINT `tb_sites_groupId_fk` FOREIGN KEY (`groupId`) REFERENCES `tb_sitegroups` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `tb_sites` WRITE;
/*!40000 ALTER TABLE `tb_sites` DISABLE KEYS */;

INSERT INTO `tb_sites` (`id`, `groupId`, `primary`, `name`, `handle`, `language`, `hasUrls`, `baseUrl`, `sortOrder`, `dateCreated`, `dateUpdated`, `dateDeleted`, `uid`)
VALUES
	(1,1,1,'REPLACE ME','default','en-US',1,'http://$DEFAULT_SITE_URL',1,'2019-03-26 23:48:50','2019-04-15 19:12:29',NULL,'19bcec29-0fe8-40ec-ab48-7caaaff62a9a');

/*!40000 ALTER TABLE `tb_sites` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_structureelements
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_structureelements`;
...
CREATE TABLE `tb_structureelements` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_structureelements_structureId_elementId_unq_idx` (`structureId`,`elementId`),
  KEY `tb_structureelements_root_idx` (`root`),
  KEY `tb_structureelements_lft_idx` (`lft`),
  KEY `tb_structureelements_rgt_idx` (`rgt`),
  KEY `tb_structureelements_level_idx` (`level`),
  KEY `tb_structureelements_elementId_idx` (`elementId`),
  CONSTRAINT `tb_structureelements_elementId_fk` FOREIGN KEY (`elementId`) REFERENCES `tb_elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_structureelements_structureId_fk` FOREIGN KEY (`structureId`) REFERENCES `tb_structures` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_structures
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_structures`;
...
CREATE TABLE `tb_structures` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_structures_dateDeleted_idx` (`dateDeleted`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_systemmessages
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_systemmessages`;
...
CREATE TABLE `tb_systemmessages` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_systemmessages_key_language_unq_idx` (`key`,`language`),
  KEY `tb_systemmessages_language_idx` (`language`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_taggroups
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_taggroups`;
...
CREATE TABLE `tb_taggroups` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_taggroups_name_idx` (`name`),
  KEY `tb_taggroups_handle_idx` (`handle`),
  KEY `tb_taggroups_dateDeleted_idx` (`dateDeleted`),
  KEY `tb_taggroups_fieldLayoutId_fk` (`fieldLayoutId`),
  CONSTRAINT `tb_taggroups_fieldLayoutId_fk` FOREIGN KEY (`fieldLayoutId`) REFERENCES `tb_fieldlayouts` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_tags
# ------------------------------------------------------------
...
CREATE TABLE `tb_tags` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_tags_groupId_idx` (`groupId`),
  CONSTRAINT `tb_tags_groupId_fk` FOREIGN KEY (`groupId`) REFERENCES `tb_taggroups` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_tags_id_fk` FOREIGN KEY (`id`) REFERENCES `tb_elements` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_templatecacheelements
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_templatecacheelements`;

CREATE TABLE `tb_templatecacheelements` (
  `cacheId` int(11) NOT NULL,
  `elementId` int(11) NOT NULL,
  KEY `tb_templatecacheelements_cacheId_idx` (`cacheId`),
  KEY `tb_templatecacheelements_elementId_idx` (`elementId`),
  CONSTRAINT `tb_templatecacheelements_cacheId_fk` FOREIGN KEY (`cacheId`) REFERENCES `tb_templatecaches` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_templatecacheelements_elementId_fk` FOREIGN KEY (`elementId`) REFERENCES `tb_elements` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_templatecachequeries
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_templatecachequeries`;
...
CREATE TABLE `tb_templatecachequeries` (
  ...
  PRIMARY KEY (`id`),
  KEY `tb_templatecachequeries_cacheId_idx` (`cacheId`),
  KEY `tb_templatecachequeries_type_idx` (`type`),
  CONSTRAINT `tb_templatecachequeries_cacheId_fk` FOREIGN KEY (`cacheId`) REFERENCES `tb_templatecaches` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_templatecaches
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_templatecaches`;
...
CREATE TABLE `tb_templatecaches` (
  ...
  PRIMARY KEY (`id`),
  KEY `tb_templatecaches_cacheKey_siteId_expiryDate_path_idx` (`cacheKey`,`siteId`,`expiryDate`,`path`),
  KEY `tb_templatecaches_cacheKey_siteId_expiryDate_idx` (`cacheKey`,`siteId`,`expiryDate`),
  KEY `tb_templatecaches_siteId_idx` (`siteId`),
  CONSTRAINT `tb_templatecaches_siteId_fk` FOREIGN KEY (`siteId`) REFERENCES `tb_sites` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_tokens
# ------------------------------------------------------------
...
CREATE TABLE `tb_tokens` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_tokens_token_unq_idx` (`token`),
  KEY `tb_tokens_expiryDate_idx` (`expiryDate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_usergroups
# ------------------------------------------------------------
...
CREATE TABLE `tb_usergroups` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_usergroups_handle_unq_idx` (`handle`),
  UNIQUE KEY `tb_usergroups_name_unq_idx` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_usergroups_users
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_usergroups_users`;
...
CREATE TABLE `tb_usergroups_users` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_usergroups_users_groupId_userId_unq_idx` (`groupId`,`userId`),
  KEY `tb_usergroups_users_userId_idx` (`userId`),
  CONSTRAINT `tb_usergroups_users_groupId_fk` FOREIGN KEY (`groupId`) REFERENCES `tb_usergroups` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_usergroups_users_userId_fk` FOREIGN KEY (`userId`) REFERENCES `tb_users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_userpermissions
# ------------------------------------------------------------
...
CREATE TABLE `tb_userpermissions` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_userpermissions_name_unq_idx` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_userpermissions_usergroups
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_userpermissions_usergroups`;
...
CREATE TABLE `tb_userpermissions_usergroups` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_userpermissions_usergroups_permissionId_groupId_unq_idx` (`permissionId`,`groupId`),
  KEY `tb_userpermissions_usergroups_groupId_idx` (`groupId`),
  CONSTRAINT `tb_userpermissions_usergroups_groupId_fk` FOREIGN KEY (`groupId`) REFERENCES `tb_usergroups` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_userpermissions_usergroups_permissionId_fk` FOREIGN KEY (`permissionId`) REFERENCES `tb_userpermissions` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_userpermissions_users
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_userpermissions_users`;
...
CREATE TABLE `tb_userpermissions_users` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_userpermissions_users_permissionId_userId_unq_idx` (`permissionId`,`userId`),
  KEY `tb_userpermissions_users_userId_idx` (`userId`),
  CONSTRAINT `tb_userpermissions_users_permissionId_fk` FOREIGN KEY (`permissionId`) REFERENCES `tb_userpermissions` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_userpermissions_users_userId_fk` FOREIGN KEY (`userId`) REFERENCES `tb_users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_userpreferences
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_userpreferences`;

CREATE TABLE `tb_userpreferences` (
  `userId` int(11) NOT NULL AUTO_INCREMENT,
  `preferences` text,
  PRIMARY KEY (`userId`),
  CONSTRAINT `tb_userpreferences_userId_fk` FOREIGN KEY (`userId`) REFERENCES `tb_users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `tb_userpreferences` WRITE;
/*!40000 ALTER TABLE `tb_userpreferences` DISABLE KEYS */;

INSERT INTO `tb_userpreferences` (`userId`, `preferences`)
VALUES
	(1,'{\"language\":\"en-US\"}');

/*!40000 ALTER TABLE `tb_userpreferences` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tb_users` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_users_uid_idx` (`uid`),
  KEY `tb_users_verificationCode_idx` (`verificationCode`),
  KEY `tb_users_email_idx` (`email`),
  KEY `tb_users_username_idx` (`username`),
  KEY `tb_users_photoId_fk` (`photoId`),
  CONSTRAINT `tb_users_id_fk` FOREIGN KEY (`id`) REFERENCES `tb_elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_users_photoId_fk` FOREIGN KEY (`photoId`) REFERENCES `tb_assets` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
VALUES
	(1,'no-email@example.com',NULL,NULL,NULL,'no-email@example.com','$2y$13$AN/quVm.twko3IeRJk0nAeBA2Fk2Y2UP7qHgzii0o89X3mYgyQQZ2',1,0,0,0,'2019-04-15 19:11:09',NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,0,'2019-03-26 23:48:51','2019-03-26 23:48:51','2019-04-15 19:11:09','8c98474c-231f-4c53-a8b5-3ac33691f2c2');

/*!40000 ALTER TABLE `tb_users` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_volumefolders
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_volumefolders`;
...
CREATE TABLE `tb_volumefolders` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_volumefolders_name_parentId_volumeId_unq_idx` (`name`,`parentId`,`volumeId`),
  KEY `tb_volumefolders_parentId_idx` (`parentId`),
  KEY `tb_volumefolders_volumeId_idx` (`volumeId`),
  CONSTRAINT `tb_volumefolders_parentId_fk` FOREIGN KEY (`parentId`) REFERENCES `tb_volumefolders` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tb_volumefolders_volumeId_fk` FOREIGN KEY (`volumeId`) REFERENCES `tb_volumes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_volumes
# ------------------------------------------------------------
...
CREATE TABLE `tb_volumes` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_volumes_name_idx` (`name`),
  KEY `tb_volumes_handle_idx` (`handle`),
  KEY `tb_volumes_fieldLayoutId_idx` (`fieldLayoutId`),
  KEY `tb_volumes_dateDeleted_idx` (`dateDeleted`),
  CONSTRAINT `tb_volumes_fieldLayoutId_fk` FOREIGN KEY (`fieldLayoutId`) REFERENCES `tb_fieldlayouts` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table tb_widgets
# ------------------------------------------------------------
...
CREATE TABLE `tb_widgets` (
  ...
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `tb_widgets_userId_idx` (`userId`),
  CONSTRAINT `tb_widgets_userId_fk` FOREIGN KEY (`userId`) REFERENCES `tb_users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `tb_widgets` WRITE;
/*!40000 ALTER TABLE `tb_widgets` DISABLE KEYS */;

INSERT INTO `tb_widgets` (`id`, `userId`, `type`, `sortOrder`, `colspan`, `settings`, `enabled`, `dateCreated`, `dateUpdated`, `uid`)
VALUES
...
/*!40000 ALTER TABLE `tb_widgets` ENABLE KEYS */;
UNLOCK TABLES;
